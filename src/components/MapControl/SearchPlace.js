...
const SearchPlace = (props) => {
  ...
  const getCoordinates = async () => {
    axios
        .get(`https://maps.googleapis.com/maps/api/geocode/json?address=${place}&key=AIzaSyC3Hxh-W7Qv8h28N_LLIoYyVG4o2wPXc9U`)
        .then(({ data }) => { //api 호출 결과로 json 데이터가 반환됨
            props.findPlace(data.results[0].geometry.location);  //좌표부분만 골라서 전달
